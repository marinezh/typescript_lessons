...
function searchLocationHandler(e) {
    e.preventDefault();
    const location = address.value;
    axios_1.default
        .get(`https://maps.googleapis.com/maps/api/geocode/json?address=${encodeURI(location)}&key=AIzaSyAuyPWb0vgdZ3j5PZ6ptox5pFoEUMoYMao`)
        .then((response) => {
